<template>
  <div class="chat-container">
    <div v-for="post in posts" :key="post.id" :class="['message', isAdmin(post) ? 'admin' : 'user']">
...
const posts = ref([
  ...
  },
  {
    ...
    "creator": {
      "name": "pieta",
      "role": { "name": "User" },
      "avatar": { "path": "http://localhost:8000/storage/avatars/UDXimCOoAjds33WYEst8z8LyhEJsz7cD6vGmnCnE.png" }
    },
